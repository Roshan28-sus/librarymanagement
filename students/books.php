  ...
  document.body.style.backgroundColor = "white";
      ...
      <div class="search">	
       ...
       <div class="search">	
      	...
      	<form class="navbar-form" method="post" name="form1">
      			...
      			<button style="background-color: #8787f5; " type="submit" name="submit1" class="btn btn-default">
      				Request 
	...
	<?php
        ...
        if(isset($_POST['submit']))
        {
        	...
        	{
        		echo "Sorry! book not found.Try searching again.";
        	}
        	else
        	{
        ...
        if(isset($_POST['submit1']))
        {
        	...
        	else
        	{
        		?>
        		<script type="text/javascript">
        			alert ("You Should Login First to request a Books.");
        		</script>
        		<?php
        	}
        }
