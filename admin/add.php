...
<h2 style="color: black; font-family: Lucide console;text-align: center;"><b>Add New Books</b></h2>
<form class="book" action="" method="post">
  ...
  <input type="text" name="edition" class="form-control" placeholder=" Boook Edition" required=""><br>
